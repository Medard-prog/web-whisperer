...
const Auth = () => {
  ...
  return (
    <PageTransition>
      <WavyBackground className="min-h-screen flex items-center justify-center px-4 py-20">
        <motion.div
          ...
          <Card className="border-2 shadow-xl">
            <CardHeader className="space-y-1">
              <div className="flex justify-center mb-4">
                <div className="bg-gradient-to-r from-brand-500 to-brand-600 text-white w-12 h-12 rounded-md flex items-center justify-center">
