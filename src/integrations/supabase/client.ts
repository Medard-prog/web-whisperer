...
// Updated fetchProjectById to properly handle project requests
export async function fetchProjectById(projectId: string): Promise<Project | null> {
  try {
    console.log("Fetching project details for:", projectId);
    
    // First, try to get the project from project_requests table
    ...
    // If found in project_requests, map it to a Project
    if (requestData) {
    ...
    // If not found in project_requests, try the projects table
    ...
    if (projectData) {
      console.log("Project found in projects table:", projectData);
      return mapProject(projectData);
    }
    
    console.log("Project not found in either table for ID:", projectId);
    return null;
  } catch (error) {
